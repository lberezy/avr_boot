...
#define UC1701_SET_POWER_FOLL_OFF   (0b00000100)
#define UC1701_SET_POWER_FOLL_ON    (0b00000000)
...
#define UC1701_MAX_COLS 8
#define UC1701_BANK_BIT_SIZE 8

#define DISPLAY_WIDTH 102
#define DISPLAY_HEIGHT UC1701_MAX_COLS * UC1701_BANK_BIT_SIZE
